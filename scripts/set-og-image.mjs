...
/**
 * Set OG share image to og-image.png for all blog posts
 */
...
async function setPostOgImage() {
  console.log('🖼 Setting OG share image to og-image.png for all posts...\n');
  ...
  try {
    ...
    for (let i = 0; i < posts.length; i++) {
      ...
      if (post.ogImage && post.ogImage.id === mediaId) {
        alreadySetCount++;
        continue;
      }
