...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/country/:slug*', destination: '/projects/ongoing', permanent: true },
      { source: '/state/:slug*', destination: '/projects/ongoing', permanent: true },
      { source: '/city/:slug*', destination: '/projects/ongoing', permanent: true },
      { source: '/area/:slug*', destination: '/projects/ongoing', permanent: true },
      { source: '/agent/:slug*', destination: '/about', permanent: true },
