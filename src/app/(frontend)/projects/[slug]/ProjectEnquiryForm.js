...
export default function ProjectEnquiryForm({ projectName }) {
      ...
      if (result.success) {
        ...
        trackFormSubmission(
          "project_enquiry",
          {
            ...
            filled_fields: Object.values(formData).filter(
              (v) => v && v.toString().trim(),
            ).length,
            submission_time: new Date().toISOString(),
          },
  ...
  return (
    <aside className={styles["enquiry-form"]}>
      <h3 className={styles["enquiry-form__heading"]}>
      ...
      >
        ...
        <div className={styles["enquiry-form__field"]}>
          <input
            ...
            aria-describedby={
              errors.mobile ? "enquiry-mobile-error" : undefined
            }
          />
          {errors.mobile && (
            <p
        ...
        <div className={styles["enquiry-form__checkbox-group"]}>
          ...
          <label
            htmlFor="whatsapp"
            className={styles["enquiry-form__checkbox-label"]}
          >
        ...
        <div className={styles["enquiry-form__field"]}>
          <input
            ...
            aria-describedby={
              errors.budget ? "enquiry-budget-error" : undefined
            }
          />
          {errors.budget && (
            <p
              id="enquiry-budget-error"
              className={styles["enquiry-form__error"]}
            >
              {errors.budget}
            </p>
        ...
        <div className={styles["enquiry-form__field"]}>
          ...
          {message && (
            <p
              className={`${styles["enquiry-form__message"]} ${styles[`enquiry-form__message--${message.type}`]}`}
            >
              {message.text}
            </p>
          )}
        ...
        <button
          type="submit"
          className={styles["enquiry-form__btn"]}
          disabled={loading}
        >
